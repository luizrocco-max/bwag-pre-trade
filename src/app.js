...
(function () {
  ...
  document.addEventListener('click', (e) => {
    const t = e.target.closest('[data-step],[data-fundo],[data-delfundo],[data-cen],[data-del],[data-gen],[data-pub],[data-rmativo],[data-zerar],#btn-exemplo,#q-exemplo,#q-modelo,#go-pretrade,#pol-reset,#cen-normalizar,#pt-print,#add-ativo-btn,#topbar-reset,#cfg-export');
    if (!t) return;
